package com.ntt.sre.reajuste.equipe2.entities;
...
public class SalaryIncrease {
	...
	public Double getIncrease() {
		return new_salary = initial_salary * ((percentage_increase/100)+1);
	}
	
	public SalaryIncrease(Long id, String office, Double initial_salary, Double percentage_increase,
			Double new_salary) {
		super();
		this.id = id;
		this.office = office;
